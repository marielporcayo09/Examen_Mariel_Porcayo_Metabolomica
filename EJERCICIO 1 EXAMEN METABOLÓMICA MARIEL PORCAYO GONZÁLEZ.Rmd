---
title: "Pregunta 1 Examen Metabolomica"
...
p_load("vroom",
       ...
       "ggplot2",
       "ggrepel",
       "matrixTests") #Para análsiis estadístico
```
...
#3
Volcano_data <-
  vroom(file="https://raw.githubusercontent.com/ManuelLaraMVZ/Transcript-mica/main/Datos%20completos%20miRNAs%20ejercicio.csv")
head(Volcano_data)
...
Volcano <- ggplot(data = ValoresVolcanoP,
  ...
  geom_point(alpha = 0.8,
             color = "black")+
  labs(title = "DISEÑA: MARIEL PORCAYO GONZÁLEZ")+
  theme_classic()+
  xlab("Log2(FC)")+
  ylab("-Log10(p-value)")+
